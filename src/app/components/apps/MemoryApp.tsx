...
const LINES: Line[] = [
  ...
  body("KC Acuin. Team Lead at Odecci Solutions, Caloocan PH."),
  body("Intern to Team Lead in three years, same company —"),
  ...
  head("# Quorfin — the 10-wave build"),
  body("An offline-first Flutter finance app we built together in"),
  body("10 structured waves: Isar + Riverpod foundation, budgeting,"),
  ...
  blank(),
  cmd("cat memory/al-fardan.md"),
  head("# Al-Fardan — iOS war stories"),
  body("Native Swift/UIKit chat. Images rendered blank for days —"),
  body("the SDWebImage callback was discarding its error param."),
  body("Root cause: a server contract quirk in how message text"),
  body("and file URLs travel. KC's rule since: never swallow"),
  ...
  teal("70% less debugging time via AI tooling"),
  teal("release cycle: 3 weeks → under 4 days"),
  teal("app crash rate down 68%"),
  blank(),
