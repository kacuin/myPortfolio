...
const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Resident-services iOS app for a regional property group. Owned the native Swift/UIKit codebase — most notably the in-app customer-service chat: attachments, image messaging, and the delivery pipeline behind them.",
    ...
    highlights: [
      ...
      "Maintained feature parity with the Android implementation",
    ],
  },
  {
